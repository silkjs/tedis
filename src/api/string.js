...
var RedisString = /** @class */ (function (_super) {
    ...
    RedisString.prototype.mget = function (key) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.command.apply(this, __spreadArray([MethodString.mget, key], __read(keys), false))];
                    case 1: return [2 /*return*/, (_a.sent())];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.command.apply(this, __spreadArray([MethodString.mset], __read(arrayKV), false))];
                    case 1: return [2 /*return*/, (_a.sent())];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.command.apply(this, __spreadArray([MethodString.msetnx], __read(arrayKV), false))];
                    case 1: return [2 /*return*/, (_a.sent())];
                }
            });
        });
    ...
    RedisString.prototype.setnx = function (key) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.command.apply(this, __spreadArray([MethodString.setnx, key], __read(keys), false))];
                    case 1: return [2 /*return*/, (_a.sent())];
                }
            });
        });
