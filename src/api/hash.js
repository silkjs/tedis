...
var RedisHash = /** @class */ (function (_super) {
    ...
    RedisHash.prototype.hdel = function (key, field) {
        ...
        return this.command.apply(this, __spreadArray([MethodHash.hdel, key, field], __read(fields), false));
    };
    ...
    RedisHash.prototype.hmget = function (key, field) {
        ...
        return this.command.apply(this, __spreadArray([MethodHash.hmget, key, field], __read(fields), false));
    };
    RedisHash.prototype.hmset = function (key, hash) {
        ...
        return this.command.apply(this, __spreadArray([MethodHash.hmset, key], __read(arrayFV), false));
    };
