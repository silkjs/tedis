...
var RedisKey = /** @class */ (function (_super) {
    ...
    RedisKey.prototype.del = function (key) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.command.apply(this, __spreadArray([MethodKey.del, key], __read(keys), false))];
    ...
    RedisKey.prototype.exists = function (key) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.command.apply(this, __spreadArray([MethodKey.exists, key], __read(keys), false))];
                    case 1: return [2 /*return*/, (_a.sent())];
                }
            });
        });
